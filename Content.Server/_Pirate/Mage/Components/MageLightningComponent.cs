...
namespace Content.Server._Pirate.Mage.Components;

[RegisterComponent]
public sealed partial class MageLightningComponent : Component
{
    /// <summary>
    ...
    public float PassiveElectrocutionChance = 0.01f;
