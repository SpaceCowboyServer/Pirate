...
welder-component-on-examine-detailed-message = Паливо: [color={$colorName}]{$fuelLeft}/{$fuelCapacity}[/color]. {$status}
...
welder-component-suicide-unlit-others-message = {$victim} б'є себе вимкненим зварювальним апаратом!
welder-component-suicide-unlit-message = Ви б'єте себе вимкненим зварювальним апаратом!
welder-component-after-interact-refueled-message = Заправлено!
welder-component-already-full = Зварювальний апарат вже повний.
